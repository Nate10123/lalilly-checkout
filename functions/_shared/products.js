...
export const PRODUCTS = {
  ...
  5: {
    ...
    // more for 2XL/3XL on this blank; the site was flat-charging $29.50
    // for every size, undercharging on the two largest.
    sizePricingCents: {
      S: 3000,
      M: 3000,
      L: 3000,
  ...
  6: {
    ...
    // Prices scale with size, same as FreakYe (same blank, same 2XL/3XL
    // upcharge from Printful) — was flat-charging $22.50 for every size.
    sizePricingCents: {
      S: 2250,
      M: 2250,
      L: 2250,
