...
const PRODUCTS = [
  ...
  },
  {
    ...
    colors: [
      { name: 'Bone', hex: '#d9cdb8', image: 'https://files.cdn.printful.com/files/675/6759719c24ca8e9096a5762703bdf338_preview.png' },
      { name: 'White', hex: '#ffffff', image: 'https://files.cdn.printful.com/files/dcc/dcc049ceacea6962b7d8656418646a60_preview.png' },
    ],
    image: 'https://files.cdn.printful.com/files/dcc/dcc049ceacea6962b7d8656418646a60_preview.png',
  ...
  },
  {
    ...
    description: "The classic. Simple, loud, and to the point. Same blank as the FreakYe tee — 100% combed cotton, regular fit, screen-printed graphic that won't crack or fade."
  },
  {
...
function updateCartUI() {
  ...
  itemsEl.innerHTML = lines.map(c => {
    ...
    const lineImage = getProductImage(c, c.color);
    return `
    <div class="cart-line">
