...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: 30.00, tag: null, fill: '#f7f3ec', bg: '#d3ecab',
    colors: [
      { name: 'Black', hex: '#14120f', image: 'https://files.cdn.printful.com/files/421/421369457d873a2455fbbf7785ebbdb3_preview.png' },
      { name: 'Maroon', hex: '#6e1f2a', image: 'https://files.cdn.printful.com/files/879/879caf14f010f563fda6e5a9da2655db_preview.png' },
    ],
    image: 'https://files.cdn.printful.com/files/421/421369457d873a2455fbbf7785ebbdb3_preview.png',
    // NOTE: description below predates the real product spec (Otto Cap
    // 18-1248, 6-panel cotton twill, embroidered) — worth a rewrite once
    // you send over the actual details, same as the others.
  ...
  },
  {
    ...
    sizePricing: { S: 30.00, M: 30.00, L: 30.00, XL: 30.00, '2XL': 32.50, '3XL': 35.50 },
    tag: 'new', fill: '#14120f', bg: '#8a8a86',
    // 4XL removed — Printful no longer syncs that size for this product.
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL'],
    colors: [
      { name: 'Bone', hex: '#d9cdb8', image: 'assets/products/freakye-bone.png' },
      { name: 'White', hex: '#ffffff', image: 'assets/products/freakye-white.png' },
    ],
    image: 'assets/products/freakye-white.png',
    description: "100% combed cotton, cut with a true-to-size regular fit and a classic crew neck — not the boxy oversized look everyone's chasing right now. Pre-shrunk and double-needle stitched at the sleeves and hem so it holds up wash after wash, with a tear-away label if you don't want the size showing."
  },
  {
    id: 6, name: 'I ♥ Lilly Pug T-Shirt', cat: 'apparel', catLabel: 'Apparel',
    sizePricing: { S: 22.50, M: 22.50, L: 22.50, XL: 22.50, '2XL': 25.00, '3XL': 27.50 },
    tag: null, fill: '#ff2f7e', bg: '#f3aac2',
    sizes: ['S', 'M', 'L', 'XL', '2XL', '3XL'],
    colors: [
      {
    ...
    image: 'assets/products/ilovelilly-white-front.png',
    description: "The classic. Simple, loud, and to the point. 100% combed cotton, regular fit, screen-printed graphic that won't crack or fade."
  },
  {
    id: 7, name: 'Lilly Life Steel Water Bottle', cat: 'accessories', catLabel: 'Accessories',
    price: 28.00, tag: null, fill: '#f7f3ec', bg: '#cfc5f5', comingSoon: true,
  ...
  },
  {
    ...
    image: 'assets/products/lillyzus-dad-hat.png',
    images: [
      'assets/products/lillyzus-dad-hat.png',
    ...
    description: "Unstructured, low-profile dad hat in 100% cotton twill — 6 panels, pre-curved visor, adjustable strap with an antique buckle. The Lillyzus embroidery sits on the back, backed by 6 matching eyelets. Broken-in feel from the first wear."
  },
  {
  ...
  },
  {
    ...
    description: "Structured bucket hat with the LA LILLY wordmark embroidered up front. One size fits most, packable, sun's out dog's out."
  },
  {
    id: 14, name: 'White Glossy Mug', cat: 'accessories', catLabel: 'Accessories',
    price: 8.50, tag: 'new', fill: '#14120f', bg: '#cfc5f5',
  ...
  },
  {
    ...
    description: "Heavyweight cotton tee with THE PUGGLER graphic front and center. Cut from a thicker, sturdier blank than the rest of the tee lineup — built to hold up."
  },
];
