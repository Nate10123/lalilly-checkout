...
const PRODUCTS = [
  ...
  },
  {
    ...
    description: "Clear case with the Lilly Bear design printed front and center, made to fit a huge range of iPhone models — from the 7/8 all the way up to the 17 lineup. Slim, shock-absorbent, and won't yellow over time."
  },
  {
    ...
    colors: [
      {
        ...
        image: 'https://files.cdn.printful.com/files/82b/82bf30620f45033968573ff1c96ce7ef_preview.png',
      },
      {
        name: 'Classic Rainbow', hex: '#ff3b30',
        image: 'https://files.cdn.printful.com/files/a61/a61eda38103cf6bcc69c4d5b5dfa6587_preview.png',
      },
    ],
    image: 'https://files.cdn.printful.com/files/f3d/f3dc5f9409cfe8c4680b6308fc27a714_preview.png',
    description: "Oversized tie-dye tee with a bold front graphic and a smaller back hit. Heavyweight cotton blank with a relaxed, boxy fit — every piece is hand-dyed, so no two shirts come out exactly alike."
  },
  {
    ...
    colors: [
      {
        ...
        image: 'https://files.cdn.printful.com/files/1cc/1ccc04ef99956353a89c80495c24ec9d_preview.png',
      },
      {
        name: 'Navy Triblend', hex: '#1b2a4a',
        image: 'https://files.cdn.printful.com/files/eae/eae1252b622c1bb6728dbae9d1e04bed_preview.png',
      },
      {
        name: 'Grey Triblend', hex: '#8c8c8c',
        image: 'https://files.cdn.printful.com/files/5ba/5ba9720793635d214d573557ea659314_preview.png',
      },
      {
        name: 'Solid White Triblend', hex: '#ffffff',
        image: 'https://files.cdn.printful.com/files/3fa/3fa536e492bddbfcb43cb2c0ba33d526_preview.png',
      },
    ],
    image: 'https://files.cdn.printful.com/files/eae/eae1252b622c1bb6728dbae9d1e04bed_preview.png',
    description: "Soft tri-blend tee with a lightly heathered feel, in four colorways. Fitted through the body with a slightly higher armhole than a standard tee — runs true to size."
  },
];
